<template>
    <div>
      ...
      <div class="info-card">
        <b-row class="my-2">
          ...
          <b-col lg="4" style="text-align:end;">
            <b-button style="display: inline-flex;" variant="success" @click="onShowModal('new')">
                DESCARGAR <span class="material-icons-sharp ml-2"> {{ '\ue2c0' }}</span>
            </b-button>
          </b-col>
        </b-row>
        <b-row>
  ...
  import Formulario from "../Form/FormularioDailyMatrix.vue";
  export default {
    name: "GridView",
    components: {
      Formulario,
